...
>
> Amendment (popover size, WF-DESIGN-0014): §3's 360×480 popover is revised to **400×670**. The
...
> (the full list measures ~661px). The shell mechanics are unchanged: still one borderless,
