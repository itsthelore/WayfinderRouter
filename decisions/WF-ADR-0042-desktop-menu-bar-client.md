...
>
> Amendment (popover size, WF-DESIGN-0014): §3's 360×480 popover is revised to **400×570**. The
...
> (the full list measures ~558px). The shell mechanics are unchanged: still one borderless,
