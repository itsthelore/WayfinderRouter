// The local-mirror preview (WF-ADR-0042 §2). The embedded JS scorer is checked against
// the frozen migration corpus and trusted ONLY behind the green build-time gate — never a routed
...
/** The CI contract job (parity.mjs, blocking) is the real enforcement; this
