...
// install-the-service CTA (the one-click WF-ADR-0038 path — the app asks the service manager,
// it never spawns the gateway itself), and a live scorer demo so the very first thing the app
// does is show a real decision — keyless, no backend, can't fail (WF-ADR-0042).
